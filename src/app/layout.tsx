          ...
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                ...
                // 1. Capture-phase listeners on window (CRITICAL: capture=true runs before Next.js listeners!)
                try {
                ...
                // 2. Wrap EventTarget.prototype.addEventListener
                try {
