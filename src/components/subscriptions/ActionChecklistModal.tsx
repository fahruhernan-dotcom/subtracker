        ...
        <div className="bezel-core p-6 flex flex-col justify-between max-h-[90vh] overflow-hidden">
            ...
            <div className="p-3.5 rounded-2xl bg-amber-500/10 dark:bg-amber-950/30 border border-amber-500/20 flex items-start justify-between gap-3">
              <div className="flex items-start gap-2.5">
                ...
                <div className="text-xs text-amber-900 dark:text-amber-200 leading-relaxed font-medium">
                  ...
                  Pastikan akun member ini sudah di-kick dari sistem / family group dan konfirmasi dikirim sebelum menandai slot kosong.
                </div>
              </div>
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-3">
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-full border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs font-bold text-slate-700 dark:text-slate-300 transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className={`group flex items-center gap-2 pl-5 pr-1.5 py-1.5 rounded-full text-xs font-bold text-white shadow-md transition-all active:scale-[0.98] cursor-pointer ${
                allCompleted
